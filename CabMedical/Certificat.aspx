<%@ Page Title="" Language="C#" MasterPageFile="~/Medecins.Master" AutoEventWireup="true" CodeBehind="Certificat.aspx.cs" Inherits="CabMedical.Certificat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="mb-3">
            ...
            <asp:TextBox ID="Textox_Numero_Certificat" runat="server" class="form-control" Width="1000px" Disabled="true" />
        </div>
        <div class="mb-3">
        ...
        <asp:Button ID="Button_View" runat="server" class="btn btn-primary" Text="View" OnClick="Button_View_Click1" />
