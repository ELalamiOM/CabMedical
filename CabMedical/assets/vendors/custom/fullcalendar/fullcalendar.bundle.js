...
exports.default = {
    ...
    registerClass: function (EventSourceClass) {
        this.sourceClasses.unshift(EventSourceClass); // give highest Criticality
    },
...
var EventRenderer = /** @class */ (function () {
    ...
    // A cmp function for determining which segments should take visual Criticality
...
var ViewSpecManager = /** @class */ (function () {
    ...
    ViewSpecManager.prototype.buildViewSpec = function (requestedViewType) {
        ...
        var specChain = []; // for the view. lowest to highest Criticality
        var defaultsChain = []; // for the view. lowest to highest Criticality
        var overridesChain = []; // for the view. lowest to highest Criticality
        ...
        if (durationInput) {
            ...
            if (duration.valueOf()) {
                ...
                // incorporate options for this. lowest Criticality
    ...
    ViewSpecManager.prototype.buildViewSpecButtonText = function (spec, requestedViewType) {
        ...
        // highest to lowest Criticality. mirrors buildViewSpecOptions
